"""TinyJot 1.2.6 - An FTP-enabled notepad.
...
def create_menu():
    ...
    edit_menu.add_command(compound="left",label="Cut", command=cut_code)
    edit_menu.add_command(compound="left",label="Font size", command=font_size)    
...
def font_size():
    global fontsize
    fontsize=11
    fontsize=simpledialog.askinteger("Size", "Enter font size (10-99):")
    if fontsize>9 and fontsize<100:
        textbox.configure(font=("Courier", fontsize))
