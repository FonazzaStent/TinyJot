...
- Copy the file TinyJot.sh into the shell script folder
  (i.e. for Ubuntu /home/.local/share/nautilus/scripts)
- Copy the app file (TinyJot_1.0.2_Linux) to a folder
- Replace text into [] with the path to the app folder
- Right click on a directory and click on the 'TinyJot' context menu voice
