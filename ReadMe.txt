...
TinyJot is a basic notepad with WebDAV and encryption capabilities. It can open,
 edit and save text files on a local drive, or open, edit and save an encrypted text
file on a remote WebDAV server.
