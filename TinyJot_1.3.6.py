"""TinyJot 1.3.6 - A WebDav enabled notepad.
...
def configure():
    ...
    configwin.title("Configure Remote")
...
def create_menu():
    ...
    sub_menu.add_command(compound="left",label="Remote", command=webdav_open,accelerator="Alt+T")
    sub_menu.add_command(compound="left",label="Remote Save", command=webdav_save_same_name,accelerator="Alt+W")
...
def aboutbox():
    ...
    url_title.configure(text="TinyJot 1.3.5", font=("Arial",15), anchor='center')
...
For remote files:\n\
\n\
- File - Remote (Alt-T), to open a file hosted on the remote server.\n\
