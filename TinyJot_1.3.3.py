"""TinyJot 1.3.3 - An FTP and WebDav enabled notepad.
...
def create_menu():
    ...
    sub_menu.add_command(compound="left",label="Remote", command=ftp_open,accelerator="Alt+T")
