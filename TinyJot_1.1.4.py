"""TinyJot 1.1.4 - An FTP-enabled notepad.
...
def create_menu():
    ...
    sub_menu.add_command(compound="left",label="FTP Open", command=configure,accelerator="Alt+T")
    sub_menu.add_command(compound="left",label="FTP Save", command=ftp_save,accelerator="Alt+V")
    #sub_menu.add_command(compound="left",label="FTP Configure", command=configure,accelerator="Alt+P")
